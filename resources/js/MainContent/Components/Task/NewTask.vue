...
const submit = () => {
  form.post(route('tasks.store', { phase_id: props.phase.id ?? 0 }), {
    preserveScroll: true,
    onFinish: () => form.reset(),
    onError: () => {
      error.value = true
...
<template>
  <div class="task-container">
    ...
    >
        ...
        <div class="icon">
          <svg viewBox="0 0 36 36">
            <g fill="none" fill-rule="evenodd">
              ...
              <circle cx="27.4" cy="27.4" fill-rule="nonzero" r="7.7"></circle>
              <path
                d="M28.2,26.5 L28.2,23.946088 C28.2,23.4873147 27.819442,23.1 27.35,23.1 C26.8772851,23.1 26.5,23.4788065 26.5,23.946088 L26.5,26.5 L23.946088,26.5 C23.4873147,26.5 23.1,26.880558 23.1,27.35 C23.1,27.8227149 23.4788065,28.2 23.946088,28.2 L26.5,28.2 L26.5,30.753912 C26.5,31.2126853 26.880558,31.6 27.35,31.6 C27.8227149,31.6 28.2,31.2211935 28.2,30.753912 L28.2,28.2 L30.753912,28.2 C31.2126853,28.2 31.6,27.819442 31.6,27.35 C31.6,26.8772851 31.2211935,26.5 30.753912,26.5 L28.2,26.5 Z"
                fill="#FFF"
                fill-rule="nonzero"
              ></path>
            </g>
      ...
      <div id="flag-menu" class="new-task-item">
        <div class="icon">
          <svg height="36" viewBox="0 0 36 36" width="36">
            <g fill="none" fill-rule="evenodd">
              <circle cx="18" cy="18" r="17.5" stroke-dasharray="3"></circle>
      ...
      <v-menu id="v-flag-menu" activator="#flag-menu"> dasdpdsaldop[kl </v-menu>
      <div class="new-task-item">
        <input
      ...
      <div class="new-task-item" @click.prevent="close">
        <div class="icon">
          <svg viewBox="0 0 512 512">
            <path
              d="m502.43 55.57-446.9 446.9a31.97 31.97 0 0 1-45.25 0 31.97 31.97 0 0 1 0-45.26l446.9-446.9a31.97 31.97 0 0 1 45.25 0 31.97 31.97 0 0 1 0 45.26z"
            ></path>
            <path
              d="M457.17 502.47 10.28 55.57a31.97 31.97 0 0 1 0-45.25 31.97 31.97 0 0 1 45.25 0l446.9 446.89a31.97 31.97 0 0 1 0 45.26 31.97 31.97 0 0 1-45.26 0z"
            ></path>
          </svg>
        </div>
      </div>
